...
namespace Ksu.Cis300.PriorityQueueLibrary
{
	public class MinPriorityQueue<TPriority, TValue> where TPriority : IComparable<TPriority>
	{
		...
		/// <summary>
		/// Checks to see if the base node has the minimun priority
		/// </summary>
		...
		/// <summary>
		/// Removes the minimum priority element and returns it
		/// </summary>
		/// <returns></returns>
		public TValue RemoveMinimumPriority() {
			...
			TValue hold = _elements.Data.Value;
